...
| Публикация расписания преподавателей | Table Importer | https://github.com/jwrobb/grav-plugin-table-importer | Импортирует CSV/YAML/JSON файл и отображает как HTML-таблицу — просто обновил файл, расписание обновилось на сайте |
